        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <Tabs defaultValue="overview" className="w-full">
                ...
                <TabsContent value="impact" className="mt-6">
                  <Card>
                    <CardContent className="p-6">
                      <h2 className="text-xl font-bold mb-6">Project Impact</h2>
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                        <div className="bg-[#0e9aa7]/10 p-6 rounded-lg text-center">
                          <h3 className="text-3xl font-bold text-[#0e9aa7] mb-2">{project.impact.beneficiaries}</h3>
                          <p className="text-gray-700">Youth Beneficiaries</p>
                        </div>
                        <div className="bg-[#0e9aa7]/10 p-6 rounded-lg text-center">
                          <h3 className="text-3xl font-bold text-[#0e9aa7] mb-2">{project.impact.communities}</h3>
                          <p className="text-gray-700">Communities Impacted</p>
                        </div>
                        <div className="bg-[#0e9aa7]/10 p-6 rounded-lg text-center">
                          <h3 className="text-3xl font-bold text-[#0e9aa7] mb-2">{project.impact.projects}</h3>
                          <p className="text-gray-700">Community Projects</p>
                        </div>
                        <div className="bg-[#0e9aa7]/10 p-6 rounded-lg text-center">
                          <h3 className="text-3xl font-bold text-[#0e9aa7] mb-2">{project.impact.businesses}</h3>
                          <p className="text-gray-700">Youth-led Businesses</p>
                        </div>
                        <div className="bg-[#0e9aa7]/10 p-6 rounded-lg text-center">
                          <h3 className="text-3xl font-bold text-[#0e9aa7] mb-2">{project.impact.employment}</h3>
                      ...
                      <div className="space-y-6">
                        <div className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
                          <h4 className="font-bold text-lg mb-2">From Dropout to Entrepreneur</h4>
                          <p className="text-gray-700 mb-4">
                            Ramesh, a school dropout from a rural village, joined our program in 2023. After completing
                            our entrepreneurship training and receiving mentorship, he started a small agricultural
                            business that now employs five people from his community.
                          </p>
                        ...
                        <div className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
                          <h4 className="font-bold text-lg mb-2">Digital Skills Transform Lives</h4>
                          <p className="text-gray-700 mb-4">
                            A group of young women from Pokhara participated in our digital skills training program.
                            Today, they run a successful digital marketing agency serving local businesses and have
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardContent className="p-6">
                  <h2 className="text-xl font-bold mb-4">Share This Project</h2>
