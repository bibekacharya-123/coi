...
export default function OurProjectsPage() {
  const featuredProjects = [
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=300&width=400",
      description:
        "A hub for technological innovation, providing resources and support for tech entrepreneurs and startups.",
      category: "Technology",
    },
  ]
    ...
    <>
      <section className="bg-[#121d3e] text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="max-w-3xl mx-auto text-lg">
            Discover the various projects initiated by Creating Opportunities International to create positive impact
            and transform lives.
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-[#121d3e] mb-8 text-center">Featured Projects</h2>
          ...
          <Tabs defaultValue="all" className="w-full">
            ...
            {projectCategories.slice(1).map((category) => (
              <TabsContent key={category} value={category.toLowerCase()}>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {[...featuredProjects, ...ongoingProjects, ...completedProjects]
