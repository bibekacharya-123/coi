...
export default function OurInitiativesPage() {
  const featuredInitiatives = [
    ...
    },
    {
      ...
      schedule: "Quarterly, 2025",
      location: "Nationwide",
      image: "/placeholder.svg?height=300&width=400",
      description: "A program designed to develop leadership skills and potential among young individuals.",
      category: "Leadership",
    },
    {
      id: 3,
      title: "Entrepreneurship Bootcamp",
      schedule: "Bi-annually, 2025",
      location: "Major Cities",
      image: "/placeholder.svg?height=300&width=400",
      description:
        "An intensive bootcamp providing aspiring entrepreneurs with the knowledge and skills to start and grow their businesses.",
    ...
    <>
      <section className="bg-[#121d3e] text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="max-w-3xl mx-auto text-lg">
            Discover the various initiatives launched by Creating Opportunities International to address specific needs
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-[#121d3e] mb-8 text-center">Featured Initiatives</h2>
            ...
            {initiativeCategories.slice(1).map((category) => (
              <TabsContent key={category} value={category.toLowerCase().replace(/\s+/g, "-")}>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {[...featuredInitiatives, ...currentInitiatives, ...upcomingInitiatives]
