            ...
            <div className="lg:col-span-2">
              ...
              <Tabs defaultValue="overview" className="w-full">
                ...
                <TabsContent value="impact" className="mt-6">
                  <Card>
                    <CardContent className="p-6">
                      <h2 className="text-xl font-bold mb-6">Expected Impact</h2>
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                        <div className="bg-[#0e9aa7]/10 p-6 rounded-lg text-center">
                          <h3 className="text-3xl font-bold text-[#0e9aa7] mb-2">{initiative.impact.participants}</h3>
                          <p className="text-gray-700">Total Participants</p>
                        </div>
                        <div className="bg-[#0e9aa7]/10 p-6 rounded-lg text-center">
                          <h3 className="text-3xl font-bold text-[#0e9aa7] mb-2">{initiative.impact.workshops}</h3>
                          <p className="text-gray-700">Workshops Per Year</p>
                        </div>
                        <div className="bg-[#0e9aa7]/10 p-6 rounded-lg text-center">
                          <h3 className="text-3xl font-bold text-[#0e9aa7] mb-2">{initiative.impact.locations}</h3>
                          <p className="text-gray-700">Locations</p>
                        </div>
                        <div className="bg-[#0e9aa7]/10 p-6 rounded-lg text-center">
                          <h3 className="text-3xl font-bold text-[#0e9aa7] mb-2">{initiative.impact.employment}</h3>
                          <p className="text-gray-700">Improved Job Prospects</p>
                        </div>
                        <div className="bg-[#0e9aa7]/10 p-6 rounded-lg text-center">
                          <h3 className="text-3xl font-bold text-[#0e9aa7] mb-2">{initiative.impact.businesses}</h3>
                          <p className="text-gray-700">Online Businesses Launched</p>
                        </div>
                      </div>

                      <h3 className="text-lg font-bold mt-8 mb-4">Success Stories</h3>
                      <div className="space-y-6">
                        <div className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
                          <h4 className="font-bold text-lg mb-2">From Novice to Digital Marketer</h4>
                          <p className="text-gray-700 mb-4">
                            Suman had no digital skills when he first attended our workshop. After completing the
                            Digital Marketing series, he secured a job as a social media manager for a local business,
                            doubling his previous income.
                          </p>
                          <div className="flex justify-end">
                            <Link href="#" className="text-[#0e9aa7] font-medium hover:underline">
                              Read full story
                            </Link>
                          </div>
                        </div>
                        ...
                        <div className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
                          <h4 className="font-bold text-lg mb-2">Empowering Women Through E-commerce</h4>
                          <p className="text-gray-700 mb-4">
                            A group of women artisans from rural Nepal used the skills learned in our E-commerce
                            workshop to start selling their handcrafted products online, reaching international
                            customers and increasing their income significantly.
                          </p>
                          <div className="flex justify-end">
                            <Link href="#" className="text-[#0e9aa7] font-medium hover:underline">
                              Read full story
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Registration for the Digital Skills Workshop Series is now open. Workshops have limited capacity, so
                  ...
                  <div className="space-y-3">
                    {initiative.resources.map((resource, index) => (
                      <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex items-center">
                          <Download className="text-gray-500 mr-3" size={18} />
                          <div>
              ...
              <Card>
                <CardContent className="p-6">
                  <h2 className="text-xl font-bold mb-4">Share This Initiative</h2>
