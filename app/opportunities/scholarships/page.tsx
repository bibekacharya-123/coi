    ...
    <>
      <section className="bg-gradient-to-r from-[#121d3e] to-[#1e3a8a] text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Scholarship Opportunities</h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-[#121d3e] mb-6">Featured Scholarships</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <FeaturedScholarshipCard
                ...
                link="/opportunities/scholarships/stem-excellence"
              />
              <FeaturedScholarshipCard
                ...
                link="/opportunities/scholarships/women-leadership"
              />
            </div>
          </div>
