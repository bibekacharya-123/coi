            ...
            <div className="lg:w-2/3">
              ...
              <div className="border-t border-b py-6 my-8">
                <div className="flex flex-wrap items-center justify-between">
                  <div>
                    <span className="text-gray-600 mr-3">Tags:</span>
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-8">
                ...
                <p className="mt-4 text-gray-700">
                  Jane is passionate about using technology to create positive social change. With over 10 years of
                  experience in education and community development, she leads our digital literacy initiatives.
                </p>
              </div>
